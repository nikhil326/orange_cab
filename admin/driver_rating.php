				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Drivers Rating</li>
						</ul><!-- /.breadcrumb -->
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<th class="center">
														...
														<th class="hidden-480">Ride Count</th>
														<th></th>
												...
												<tbody>
												<?php $myresult = mysqli_query($connect,"select * from vehicle ve inner join tbl_driver cu on cu.dr_id = ve.dr_id inner join tbl_category cat on cat.cat_id = ve.vehicle_cat_id");
														$i = 1;
												...
												?>
													<tr>
														...
														<td>
															<a href="driver_view.php?id=<?php echo base64_encode(serialize($row['dr_id'])); ?>"><i class="ace-icon fa fa-eye bigger-130"></i></a>
														</td>
