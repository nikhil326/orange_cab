				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Closed And Opened Booking</a>
							</li>
							<li class="active">List of Closed And Opened Booking</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Closed Booking And Opened Booking
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									List of Closed And Opened Booking
								</small>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
                                     ...
                                     <a href="booking_report_print.php"><strong>Print<strong></a>
