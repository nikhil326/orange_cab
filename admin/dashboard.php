<?php include('config.php');
	...
	@session_start();
@ob_start();
$query	=	mysqli_query($connect,"SELECT count(dr_id) as numb FROM tbl_driver");

$arrsuccess	=	mysqli_fetch_assoc($query);

$query	=	mysqli_query($connect,"SELECT count(cust_id) as numb FROM tbl_customer");

$customer	=	mysqli_fetch_assoc($query);

$query	=	mysqli_query($connect,"SELECT count(dr_id) as numb FROM tbl_driver where status = 'Active'");

$driver_duty	=	mysqli_fetch_assoc($query);

$query	=	mysqli_query($connect,"SELECT count(dr_id) as numb FROM tbl_driver where status = 'Inactive'");

$driver_offduty	=	mysqli_fetch_assoc($query);
?>
<!DOCTYPE html>
<html lang="en">
	<head>
									...
									<div class="col-md-12 infobox-container">
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php echo $arrsuccess['numb']; ?></span>
												<div class="infobox-content">Total No. of Drivers</div>
											</div>
										...
										<div class="infobox infobox-blue">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php echo $customer['numb']; ?></span>
												<div class="infobox-content">Total No. of Customers</div>
											</div>
										...
										<div class="infobox infobox-pink">
											<div class="infobox-icon">
												<i class="ace-icon fa fa-toggle-on"></i>
											</div>

											<div class="infobox-data">
												<span class="infobox-data-number"><?php echo $driver_duty['numb']; ?></span>
												<div class="infobox-content">Total No. of On Duty Drivers</div>
											</div>
										...
										<div class="infobox infobox-red">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php echo $driver_offduty['numb']; ?></span>
												<div class="infobox-content">Total No. of Off Duty Drivers</div>
											</div>
										</div>
										...
										<div class="infobox infobox-orange2">
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">Top Custmers</div>
											</div>
