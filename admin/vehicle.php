				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">List of Vehicle</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							...
							<a href="add_vehicle_info.php"><button class="btn btn-primary">ADD Vehicle</button></a>
						</div><!-- /.page-header -->
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												?>
													<tr>
														...
														<td>
															<a href="vehicle_view.php?id=<?php echo base64_encode(serialize($row['vehicle_id'])); ?>"><?php echo $i++; ?></a>
														</td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="vehicle_view.php?id=<?php echo base64_encode(serialize($row['vehicle_id'])); ?>">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			if(checkstr == true){
			 window.location.href = 'vehicle_delete.php?id='+x;
