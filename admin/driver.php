				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">List of Driver</li>
						</ul><!-- /.breadcrumb -->
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>Driver Name</th>
														<th>Photo ID</th>
														<th class="hidden-480">Driver Contact No.</th>
														<th class="hidden-480">Date Of Birth</th>
														<th>
															
															Address
														</th>
														<th class="hidden-480">Licence Number</th>
												...
												?>
													<tr>
														...
														<td>
															<a href="driver_view.php?id=<?php echo base64_encode(serialize($row['dr_id'])); ?>"><?php echo $i++; ?></a>
														</td>
														<td><?php echo $row['dr_name']; ?></td>
														<td><img src="<?php echo $row['photo_id']; ?>" alt="" width="50px" height="50px"/></td>
														<td class="hidden-480"><?php echo $row['dr_mob']; ?></td>
														<td><?php echo $row['dob']; ?></td>
														<td><?php echo $row['dr_add']; ?></td>

														<td class="hidden-480">
															<span class="label label-sm label-warning"><?php echo $row['licence_no']; ?></span>
														</td>

														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="driver_view.php?id=<?php echo base64_encode(serialize($row['dr_id'])); ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>|
																<button class="blue" href ='' onClick="deleteItem(<?php echo $row['dr_id']; ?>)" style="border:none; background:#FFFFFF;">
																	<i class="ace-icon fa fa-trash-o bigger-130" aria-hidden="true"></i>
																</button>|
																<a class="blue" href="add_vehicle.php?id=<?php echo base64_encode(serialize($row['dr_id'])); ?>">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			if(checkstr == true){
			 window.location.href = 'driver_delete.php?id='+x;
